...
typedef enum GameConst
{
	...
	GAME_CONST_MAX_ENTITIES__BITS = MACRO_GET_BITS_CONST(GAME_CONST_MAX_PLAYERS * 100),
	...
	GAME_CONST_SERVER_PACKET_SIZE__BITS = MACRO_GET_BITS_CONST(GAME_CONST_SERVER_PACKET_SIZE),
	...
	GAME_CONST_POSITION_INTEGER_BITS = MACRO_GET_BITS_CONST(GAME_CONST_HALF_ARENA_SIZE + GAME_CONST_HALF_ARENA_CLEAR_ZONE),
...
typedef enum FixedPoint
{
	...
	DEF_FIXED_POINT(RADIUS, MACRO_GET_BITS_CONST(512), 10)
}
FixedPoint;
